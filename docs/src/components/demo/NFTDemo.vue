  ...
  <div class="nft-demo max-w-4xl mx-auto p-6">
    <div class="bg-white rounded-lg shadow-lg p-8">
      ...
      <p class="text-gray-600 mb-8">
        Demonstrate moving an NFT between chains using NXCC workers without
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
          ...
          >
            <div
              class="w-24 h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg mx-auto mb-4"
            ></div>
            <h3 class="font-medium text-gray-900">
              Demo Token #{{ nft.tokenId }}
            </h3>
            <p class="text-sm text-gray-500 mt-1">{{ nft.metadata }}</p>
            <div
              class="mt-3 px-3 py-1 bg-gray-100 rounded-full text-sm font-medium text-gray-700 inline-block"
            >
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            ...
            <button
              @click="moveNFT"
              :disabled="
                !selectedChain || isMoving || selectedChain === nft.currentChain
              "
            ...
            >
              ...
              <span v-else>
                Move NFT to
                {{
                  selectedChain ? getChainName(selectedChain) : "Selected Chain"
                }}
              </span>
            </button>
          </div>
          ...
          <div v-if="statusMessage" class="p-4 rounded-lg" :class="statusClass">
            ...
            <div v-if="moveResult" class="mt-2 text-xs opacity-75">
              ...
              <p>
                Transaction:
                {{ moveResult.transactionHash?.substring(0, 20) }}...
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <ul class="text-sm text-gray-600 space-y-1">
          <li>
            • The NFT movement is handled by an NXCC worker running in a trusted
            execution environment
          </li>
          <li>
            • No direct blockchain transactions are required from your browser
          </li>
