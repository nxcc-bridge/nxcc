...
import SecretSharingDiagram from "../../../../../assets/diagrams/secret-sharing.svg";
...
## Secret Acquisition and Sharing
...
<div class="nxcc-diagram-wrap">
  <SecretSharingDiagram
    class="nxcc-diagram"
    role="img"
    aria-label="Secret acquisition and sharing flow between nXCC nodes, policies, and enclaves."
  />
</div>
