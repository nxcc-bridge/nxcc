...
1. **[Blockchain Events](/docs/guides/blockchain-events/)** - Build workers that react to on-chain events across multiple blockchains

2. **[Identities & Policies](/docs/guides/identities-policies/)** - Add secure credential management and access controls
