...
The `policy()` function from the NXCC SDK handles all the boilerplate for you - parsing requests, handling the `_policy` endpoint, error handling, and response formatting. You just need to focus on your authorization logic.
